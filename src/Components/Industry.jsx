                    ...
                    <div className="m-auto flex flex-wrap justify-center gap-6 mt-10">
                        {
                            jobCategories.map((category, index) => (
                                <ul key={index} className="w-[420px] flex items-center gap-4 p-6 bg-white rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-none hover:bg-[#95b7e5] group transition duration-200 ">
                                    <li className="text-3xl bg-gray-100 w-[80px] h-[60px] rounded-sm flex items-center justify-center group-hover:bg-[#fff]">
                                        {category.icon}
                                    </li>
                                    <li className='w-full text-start'>
                                        <h3 className="text-lg font-semibold text-gray-900 group-hover:text-[#fff] duration-200 tracking-widest">{category.title}</h3>
